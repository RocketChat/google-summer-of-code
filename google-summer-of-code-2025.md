...
Final Update **December 7, 2025**  we have completed all the project evaluations and all of our projects in 2025 has passed.   Thanks to the enthusiastic mentors (majority of them are returning community contributors) for helping to convert two of the lagging projects into passing ones.  Contributors this year, have presented their projects proudly at the [Rocket.Chat GSoC 2025 Demo Day](https://www.youtube.com/watch?v=s0CkCynrD0U&list=PLee3gqXJQrFVL0K1-8gNaGMGg5nE1frTI) - supported by their mentors, fellow contributors, and GSoC alumni.  During the GSoC 2025 season, we like to shared that we have welcomed over 1500 new contributors to open source from all over the world, with 251 contributors creating 77 Merged PRs, 167 Open PRs, and 339 Issues in our open source repositories. 
