...
💪**Desired Skills:** Rocket.Chat App development. LLMs. Experience with calendar APIs (like Google Calendar API, Microsoft Graph API).

🎯**Goals/Deliverables:** A flexible Smart Scheduling Assistant that can understand and respond to scheduling requests in any conversation on Rocket.Chat.
