...
Results for 2026 has been announced on **April 30th, 2026**.  Thanks to the enthusiastic support from new contributors and the continued strong support of returning community mentors, Google has selected **TEN** Rocket.Chat projects!      

Mentors of selected projects has start welcoming the contributors officially and bringing them into our community bonding activities immediately; many are already refining their upcoming schedule together since they are already active in our community.  **8 mentors this year are returning GSoC contributors from prior years**;  we sincerely thank them for their continued support for open source.  
...
| ---------------- | --------------------------------------- | ---------------------------------------------- |
| Devansh Kansagra | Rebuilding Jira Integration App for Rocket.Chat | Felipe Scuciatto, Vipin Chaudhary |
| Rahian   | Room Header Buttons Ordering |	Martin Schoeler, Guilherme Gazzo |
| Amit Ashutosh  | 	High-Performance Message Parser Rewrite   | Matheus Cardoso, Ahmed.Nasser  |
| Aryan69 | EmbeddedChat 2026: Modernize APIs, Enable Matrix Federation, Add Pluggable AI, and Improve Mobile UX  |Zishan_Ahmad   |
| Echo Xiao  | Rocket.Chat: Code Analyzer Agentic Inference Context Reduction Mechanics | Dnouv, William Liu   |
| Kartik Doda   | OpenClaw Integration for Rocket.Chat   | Jeffrey Yu        |
| Khizar Shah| Agenda Jobs Admin Page| Douglas Gubert, Kevin Aleman     |
| Meet.jain| New Users Anti Spammer System |Gabriel Casals, Alfredo Del Fabro Neto    |
| Sezal Lagwal| Minimal MCP Server Generator for Rocket.Chat | Hardik Bhatia, Dhairyashil Shinde      |
| Srijna Bhargav| Refactor Virtualized Lists to Use TanStack Virtual | 	Martin Schoeler, Douglas Fabris   |

We have planned a welcome meeting for all mentors and contributors of selected projects in mid May; participants will have opportunity to network with one another, share their plans and experiences and get any related questons answered during the session.   Meanwhile we continue to host weekly tea time (casual office hour) for all interested community members (not restricted to GSoC selected contributors).
